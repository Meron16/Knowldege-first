...
use App\Filament\Resources\DomesticRegistrationResource\Pages;
use App\Models\DomesticRegistration;
use Filament\Forms;
...
class DomesticRegistrationResource extends Resource
{
    protected static ?string $model = DomesticRegistration::class;
 ...
 return $form->schema([
    ...
    {
        return [
            'index' => Pages\ListDomesticRegistrations::route('/'),
            'create' => Pages\CreateDomesticRegistration::route('/create'),
            'edit' => Pages\EditDomesticRegistration::route('/{record}/edit'),
        ];
    }

...
{
    protected static ?string $model = InternationalRegistration::class;
 ...
 return $form->schema([
    ...
    public static function getPages(): array
    {
        return [
            ...
            'create' => Pages\CreateInternationalRegistration::route('/create'),
            'edit' => Pages\EditInternationalRegistration::route('/{record}/edit'),
        ];
    }
